...
The system is live at [https://happy-rat-60-r34pca95v9ys.deno.dev/](https://happy-rat-60-r34pca95v9ys.deno.dev/)
...
### fix, then normalize deployment

The fileserver driver was overwritten by a git glitch

1. fix the glitch
2. convert to standard static file service methodology for deno deploy
